set project_dir    "./zybo_z7_20_stopwatch"
set project_name   "zybo_z7_20_stopwatch"
set project_target "xc7z020clg400-1"
set source_files {../../misc/stopwatch.vhd \
		  ../../utils/pwm.vhd \
		  ./zybo_z7_20_stopwatch.vhd \
		  }
set constraint_files {./zybo_z7_20_stopwatch.xdc}
